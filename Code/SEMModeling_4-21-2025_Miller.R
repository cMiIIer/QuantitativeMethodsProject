...
chlor<- chlor[,-1]
chlor<- chlor[!chlor$Enclosure=="M",]
chlor<- chlor[!chlor$Enclosure=="T",]# remove middle and tank measurments
...
## Data Cleanup
systemData$Chl.a.concentration<- log(systemData$Chl.a.concentration) # normalize data
...
hist((final_system_data$Current.Density))
...
plot(
  ...
  layout="circle" # change plot layout - some layouts obscure some paths.
